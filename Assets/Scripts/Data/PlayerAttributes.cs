...
public class PlayerAttributes
{
    #region 基础属性
    [Header("基础属性")]
    public int baseStrength = 10;      // 基础力量
    ...
    #region 装备加成属性
    [Header("装备加成")]
    public int equipmentStrength = 0;      // 装备力量加成
    ...
    #region 技能加成属性
    [Header("技能加成")]
    public int skillStrength = 0;      // 技能力量加成
    ...
    #region 临时加成属性
    [Header("临时加成")]
    public int temporaryStrength = 0;      // 临时力量加成
    ...
    /// 总智力值
    /// </summary>
    public int TotalIntelligence => baseIntelligence + equipmentIntelligence + skillIntelligence + temporaryIntelligence;
