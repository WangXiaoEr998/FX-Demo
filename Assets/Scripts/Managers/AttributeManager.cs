...
public class AttributeManager : MonoBehaviour
{
    ...
    private void RegisterEvents()
    {
        ...
        EventManager.Instance?.RegisterEvent("OnProfessionChanged", OnProfessionChanged);
        EventManager.Instance?.RegisterEvent("OnSkillLearned", OnSkillLearned);
        EventManager.Instance?.RegisterEvent("OnItemEquipped", OnItemEquipped);
        EventManager.Instance?.RegisterEvent("OnItemUnequipped", OnItemUnequipped);
    }
    ...
    private void UnregisterEvents()
    {
        ...
        EventManager.Instance?.UnregisterEvent("OnPlayerLevelUp", OnPlayerLevelUp);
        EventManager.Instance?.UnregisterEvent("OnProfessionChanged", OnProfessionChanged);
        EventManager.Instance?.UnregisterEvent("OnSkillLearned", OnSkillLearned);
        EventManager.Instance?.UnregisterEvent("OnItemEquipped", OnItemEquipped);
        EventManager.Instance?.UnregisterEvent("OnItemUnequipped", OnItemUnequipped);
    }
    #endregion
    ...
    private void RecalculateAttributes()
    {
        ...
        // 触发属性更新事件
        EventManager.Instance?.TriggerEvent("OnAttributesUpdated", _currentAttributes);
    }
