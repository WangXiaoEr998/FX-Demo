...
public class GameManager : MonoBehaviour
{
    ...
    public void PauseGame()
    {
        ...
        // 触发暂停事件
        EventManager.Instance?.TriggerEvent("OnGamePaused");
    ...
    public void ResumeGame()
    {
        ...
        // 触发恢复事件
        EventManager.Instance?.TriggerEvent("OnGameResumed");
    ...
    private void OnGameStateChanged(GameState previousState, GameState newState)
    {
        ...
        // 触发状态改变事件
        EventManager.Instance?.TriggerEvent("OnGameStateChanged", new GameStateEventArgs(previousState, newState));
    }
...
public class GameStateEventArgs
{
    ...
    public GameStateEventArgs(GameState previousState, GameState newState)
    {
