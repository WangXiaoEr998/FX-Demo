...
public class SystemManager : MonoBehaviour
{
    ...
    public void InitializeSystems()
    {
        ...
        // 触发系统初始化完成事件
        EventManager.Instance?.TriggerEvent("OnSystemsInitialized");
    ...
    public void StartSystems()
    {
        ...
        // 触发系统启动完成事件
        EventManager.Instance?.TriggerEvent("OnSystemsStarted");
    ...
    public void ShutdownSystems()
    {
        ...
        // 触发系统关闭完成事件
        EventManager.Instance?.TriggerEvent("OnSystemsShutdown");
