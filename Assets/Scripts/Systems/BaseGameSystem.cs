...
public abstract class BaseGameSystem : MonoBehaviour, IGameSystem
{
    ...
    {
        EventManager.Instance?.TriggerEvent(eventName, eventArgs);
    }
    ...
    {
        EventManager.Instance?.RegisterEvent(eventName, callback);
    }
    ...
    {
        EventManager.Instance?.UnregisterEvent(eventName, callback);
    }
    #endregion
}
