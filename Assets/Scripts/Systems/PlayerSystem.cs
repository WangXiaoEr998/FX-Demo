...
public class PlayerSystem : BaseGameSystem
{
    ...
    public bool CreateNewPlayer(string playerName, ProfessionType initialProfession)
    {
        ...
        try
        {
            ...
            // 触发玩家创建事件
            TriggerEvent("OnPlayerCreated", new PlayerCreatedEventArgs(_playerData));
    ...
    public bool LoadPlayer(PlayerData playerData)
    {
        ...
        try
        {
            ...
            // 触发玩家加载事件
            TriggerEvent("OnPlayerLoaded", new PlayerLoadedEventArgs(_playerData));
    ...
    public void SavePlayerData()
    {
        ...
        try
        {
            ...
            // 通过DataManager保存
            DataManager.Instance?.UpdatePlayerData(_playerData);
            DataManager.Instance?.SaveGameData();

            // 触发保存事件
            TriggerEvent("OnPlayerDataSaved", new PlayerDataSavedEventArgs(_playerData));
    ...
    public void RespawnPlayer()
    {
        ...
        try
        {
            ...
            // 触发重生事件
            TriggerEvent("OnPlayerRespawned", new PlayerRespawnedEventArgs(_playerData));
    ...
    public void AddExperience(int amount)
    {
        ...
        // 触发经验值变化事件
        TriggerEvent("OnExperienceChanged", new ExperienceChangedEventArgs(amount, _playerData.experience));
    }
    ...
    public void AddGold(int amount)
    {
        ...
        // 触发金币变化事件
        TriggerEvent("OnGoldChanged", new GoldChangedEventArgs(amount, _playerData.gold));
    }
    ...
    public void ModifyHealth(int amount)
    {
        ...
        // 触发生命值变化事件
        TriggerEvent("OnHealthChanged", new HealthChangedEventArgs(amount, _playerData.currentHealth, _playerData.maxHealth));
    ...
    private void LoadConfigurations()
    {
        ...
        {
            _playerConfig = DataManager.Instance?.GetConfig<PlayerConfig>("PlayerConfig");
        }

        if (_merchantConfig == null)
        {
            _merchantConfig = DataManager.Instance?.GetConfig<ProfessionConfig>("MerchantConfig");
        }

        if (_cultivatorConfig == null)
        {
            _cultivatorConfig = DataManager.Instance?.GetConfig<ProfessionConfig>("CultivatorConfig");
        }
    ...
    {
        _professionManager?.Update(deltaTime);
        _skillManager?.Update(deltaTime);
        _attributeManager?.Update(deltaTime);
    }
    ...
    private void ChangePlayerState(PlayerState newState)
    {
        ...
        // 触发状态改变事件
        TriggerEvent("OnPlayerStateChanged", new PlayerStateChangedEventArgs(oldState, newState));
    }
    ...
    private void HandlePlayerDeath()
    {
        ...
        // 触发死亡事件
        TriggerEvent("OnPlayerDeath", new PlayerDeathEventArgs(_playerData));
    }
    ...
    private void CheckLevelUp(int oldLevel)
    {
        ...
        if (newLevel > oldLevel)
        {
            ...
            // 触发升级事件
            TriggerEvent("OnPlayerLevelUp", new PlayerLevelUpEventArgs(oldLevel, newLevel));
        }
    }
