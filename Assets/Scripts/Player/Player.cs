...
public class Player : MonoBehaviour
{
    ...
    private void HandleInteraction()
    {
        ...
        // 触发交互事件
        EventManager.Instance?.TriggerEvent("OnPlayerInteraction", transform.position);
    }
    ...
    private void HandleInventoryToggle()
    {
        ...
        // 触发UI事件
        EventManager.Instance?.TriggerEvent("OnToggleInventory", null);
    }
    ...
    private void HandleCharacterPanelToggle()
    {
        ...
        // 触发UI事件
        EventManager.Instance?.TriggerEvent("OnToggleCharacterPanel", null);
    }
    #endregion
